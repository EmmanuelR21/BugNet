...
exports.seed = async function (knex) {
  ...
  await knex('bugs').insert([
    ...
    { bug_id: 4, project_id: 1, user_id: 1, title: 'trying to console log 0-10', description: 'waka-flaka waka-flaka waka-flaka waka-flaka waka-flaka waka-flaka waka-flaka ', code: 'for (let i = 1; i < 10; i++) {console.log(i)}', status: 'tdo', feedback: null, code_feedback: null, },
  ]);
};
